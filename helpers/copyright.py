...
BOT_MESSAGES = {
    ...
    "my_adv": "Оголошення:\n",
    "no_adv": "У вас немає опублікованих оголошень!\n",
    "adv_needed": "Для пошуку по оголошеннях, ви повинні опублікувати щонайменше одне власне",
    ...
    "parameters": {
        ...
        "reply_markup": {
            "inline_keyboard": [
                [
                    {
                        "text": "🔍 Пошук оголошень",
                        "callback_data": "KEY_CALLBACK:search_adv",
                    }
                ],
                [
                    {
...
def send_my_adv_kb(adv_text: str):
    return {
        "method": "sendMessage",
        "parameters": {
            "text": f"{BOT_MESSAGES['my_adv']}\n{adv_text}",
            "reply_markup": {
                "inline_keyboard": [
                    [
                        {"text": "🗑", "callback_data": "KEY_CALLBACK:adv_rm"},
                        {"text": "➡️", "callback_data": "KEY_CALLBACK:adv_next"},
                    ],
                    [
                    {"text": "↩️ меню", "callback_data": "KEY_CALLBACK:menu"}
                    ],
