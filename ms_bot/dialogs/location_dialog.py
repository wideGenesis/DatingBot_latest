...
from ..helpers.telegram_helper import reverse_geocode
...
class RequestLocationDialog(ComponentDialog):
    def __init__(
        ...
        super(RequestLocationDialog, self).__init__(dialog_id or RequestLocationDialog.__name__)
        self.telemetry_client = telemetry_client
        self.user_state = user_state
        self.user_profile_accessor = self.user_state.create_property("CustomerProfile")

        self.add_dialog(TextPrompt(TextPrompt.__name__, RequestLocationDialog.answer_prompt_validator))
        self.add_dialog(
            WaterfallDialog(
    ...
    async def back_to_parent(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        result_from_previous_step = step_context.context.activity.channel_data['message']['location']
    ...
    async def answer_prompt_validator(prompt_context: PromptValidatorContext) -> bool:
        ...
        _location = prompt_context.context.activity.channel_data['message'].get('location')
