...
class FileAccessDialog(ComponentDialog):
    def __init__(
        ...
        self.add_dialog(TextPrompt(TextPrompt.__name__, FileAccessDialog.answer_prompt_validator))
    ...
    async def show_file_0_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def parse_0_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def show_file_1_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def parse_1_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def show_file_2_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def parse_2_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def show_file_3_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def parse_3_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
    ...
    async def yield_file_and_kb(
        ...
        if item.get('file_type') == 0:
            activities.append(Activity(
                channel_data=json.dumps(send_video_kb(item['file'], item['privacy_type'])),
                type=ActivityTypes.message,
            )
            )
        else:
            activities.append(Activity(
                channel_data=json.dumps(send_photo_kb(item['file'], item['privacy_type'])),
                type=ActivityTypes.message,
            )
            )
