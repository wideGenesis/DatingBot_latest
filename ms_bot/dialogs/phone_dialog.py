...
class RequestPhoneDialog(ComponentDialog):
    def __init__(
        ...
        super(RequestPhoneDialog, self).__init__(
            dialog_id or RequestPhoneDialog.__name__
        )
        ...
        self.add_dialog(
            TextPrompt(TextPrompt.__name__, RequestPhoneDialog.answer_prompt_validator)
        )
        self.add_dialog(
            WaterfallDialog(
                "RequestPhoneDialog", [self.request_phone_step, self.back_to_parent]
            )
        )
        ...
        request_geo = {
            ...
            "parameters": {
                ...
                "reply_markup": {
                    ...
                    "keyboard": [[{"text": "✅ Підтвердити", "request_contact": True}]],
                },
            },
        }
    ...
    async def answer_prompt_validator(prompt_context: PromptValidatorContext) -> bool:
        _contact = prompt_context.context.activity.channel_data["message"].get(
            "contact"
        )
