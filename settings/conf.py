...
class AzureBotConfig(BaseSettings):
    ...
    APP_INSIGHTS_INSTRUMENTATION_KEY: str = os.environ.get(
        "APP_INSIGHTS_INSTRUMENTAL_KEY", ""
    )
...
class FastApiConfig(BaseSettings):
    ...
    TAGS_META = [
        ...
        },
        {
            ...
            "description": "Создание, редактирование, удаление и просмотр пользовательского профиля",
        },
        {
            "name": "Advertisement",
