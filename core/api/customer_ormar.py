...
from core.crud.customer import CustomerService, EXCLUDE_FOR_LIST, EXCLUDE_FOR_LIST_BY_CITY, EXCLUDE_FOR_GET, \
    EXCLUDE_FOR_POST
...
@router.get('/get-member_id/{member_id}',
            response_model=Customer,
...
@router.get('/get-nickname/{nickname}',
            response_model=Customer,
            response_model_exclude=EXCLUDE_FOR_GET,
            status_code=status.HTTP_201_CREATED
            )
